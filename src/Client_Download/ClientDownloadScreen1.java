 ...
 */
public class ClientDownloadScreen1 extends javax.swing.JFrame {
...
//        System.out.println("Original Image Dimensions: Width = " + originalWidth + " Height = " + originalHeight);
    ...
    private void initComponents() {
        ...
        Button1.add(jLabel1);
        jLabel1.setBounds(40, 0, 130, 40);

        jPanel1.add(Button1);
        Button1.setBounds(478, 308, 213, 45);

        image1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client1/c2.png"))); // NOI18N
        jPanel1.add(image1);
    ...
    private void Button1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Button1MouseClicked
        ClientDownloadScreen2 cds2 = new ClientDownloadScreen2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientDownloadScreen1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientDownloadScreen1().setVisible(true);
            }
        });
    }
