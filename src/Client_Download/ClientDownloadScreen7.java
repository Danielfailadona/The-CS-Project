 ...
 */
public class ClientDownloadScreen7 extends javax.swing.JFrame {
...
//        System.out.println("Original Image Dimensions: Width = " + originalWidth + " Height = " + originalHeight);
    ...
    private void initComponents() {
        ...
        image1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Client1/c8_1170x640.jpg"))); // NOI18N
        jPanel1.add(image1);
...
//        use.delay(5, () -> {
//            ClientDownloadScreen9 ds9 = new DownloadScreen9();
//            ds9.setVisible(true);
//            this.dispose();
//        });
        use.delay(5, () ->
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientDownloadScreen7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientDownloadScreen7().setVisible(true);
            }
        });
    }
