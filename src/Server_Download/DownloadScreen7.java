...
public class DownloadScreen7 extends javax.swing.JFrame {
...
//        System.out.println("Original Image Dimensions: Width = " + originalWidth + " Height = " + originalHeight);
    ...
    private void initComponents() {
        ...
        image1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/s7.png"))); // NOI18N
        jPanel1.add(image1);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        use.delay(3, () -> {
            DownloadScreen8 ds8 = new DownloadScreen8();
            ds8.setVisible(true);
            this.dispose();
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DownloadScreen7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DownloadScreen7().setVisible(true);
            }
        });
    }
